...
export function InvestorLayout({ children, currentPage, onNavigate }: InvestorLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <DisclaimerBanner />
        ...
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 bg-sky-100 text-sky-700 dark:bg-sky-900/50 dark:text-sky-300 rounded-full">
                Investor
              </span>
            </div>
          </div>
            ...
            {menuItems.map((item, idx) => (
              <button
                ...
                className={cn(
                  ...
                  currentPage === item.id
                    ? "bg-gradient-to-r from-sky-600 to-blue-700 text-white shadow-md shadow-sky-500/20 dark:from-sky-500 dark:to-blue-600"
